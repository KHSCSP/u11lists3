print("\n---- part 1, 20 items ----")
# create any list with at least 20 items
# print the message "the first 3 items are:" then use slicing to print the first 3 items
# print the message "3 items near the middle are:" then use slicing to display those items
# print the message "the last 3 items are:" then display those items
...
Traditionally, the prefix number 555 has been used to provide directory information and assistance.
...
You should output the suffix of s that begins with the first occurrence of the letter a.
 '''
